/* ==============================================================
 * content.js — auto-applies Per-Site Style Profiles, injects
 * ad-hoc CSS snippets on demand, and preserves Daltonization logic
 * ==============================================================*/
...
/* ---------- 2. Live CSS-snippet injector ---------------------- */
function injectSnippetCSS(css) {
  const STYLE_ID = 'ws-snippet';
...
chrome.runtime.onMessage.addListener((req) => {
  ...
  if (req.action === 'applySnippet')    injectSnippetCSS(req.css);
});

/* ==============================================================
 * 4. Original Daltonization logic (unchanged)
 * ==============================================================*/
